...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Store user data (mock authentication)
    localStorage.setItem(
      'user',
      JSON.stringify({
        id: '1',
        name: 'Kaveeshan',
        email: email || 'kaveeshan@syncboard.com',
        ...
        <main className="flex items-center justify-center px-4 py-16">
          <div className="w-full max-w-md">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400 mt-2">Sign in to continue to SyncBoard</p>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl shadow-2xl shadow-black/50 backdrop-blur-xl p-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-sm text-violet-400 hover:text-violet-300 font-medium">
                    Forgot password?
                  </a>
                </div>
